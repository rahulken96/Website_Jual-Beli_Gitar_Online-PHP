                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($produk as $row) : ?>
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <a href="index.php?halaman=hapus&id=<?= $row['id_produk']; ?>" class="btn-danger btn mt-2" onclick="return confirm('Yakin?');"><i class="fa fa-trash">Hapus</i></a>
                                                    <a href="index.php?halaman=ubah&id=<?= $row['id_produk']; ?>" class="btn-info btn mt-2"><i class="fa fa-edit">Ubah</i></a>
                                                </td>
                                            </tr>
                                            <?php $nomor++; ?>
                                        <?php endforeach; ?>
