      ...
      <div class="contain">
          <h1>Login</h1>
            <form class="login">
                ...
                <table>
                  <tr>
                      <td><button class="signup" type="submit" style="margin-right: 50px;" formaction="signup.php"> Sign Up</button></td>
                      <td><button class="login" type="submit" style="margin-right: 50px;">Login</button></td>
                  </tr>
                </table>
            </form>
        </div>     
